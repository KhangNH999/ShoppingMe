				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-star"></i> Yêu thích</a>
								</li>
					...
					<div class="col-sm-5">
						<form action="{{URL::to('/tim-kiem')}}" method="post">
							...
							<div class="search_box pull-right">
								...
								<input type="submit" name="search_items" style="margin-top: 0;color: white" class="btn btn-primary btn-sm" value="Tìm kiếm"/>
							</div>
						</form>
					</div>
				</div>
